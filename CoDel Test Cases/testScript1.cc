...
CoDelPeekTestMark::DoRun(){
  ...
  Simulator::Schedule(firstDequeueTime * 5, &CoDelPeekTestMark::Peek, this, queue);
  Time nextDequeueTime = firstDequeueTime + 2 * queue->GetInterval();
...
int main(){
    NS_LOG_UNCOND("------------------------------");
    NS_LOG_UNCOND("Test 1 for CoDel without Marking");
    NS_LOG_UNCOND("------------------------------");
    ...
    NS_LOG_UNCOND("-------------------------------------");
    NS_LOG_UNCOND("Test 1 for CoDel with Marking(only ECN)");
    NS_LOG_UNCOND("-------------------------------------");
