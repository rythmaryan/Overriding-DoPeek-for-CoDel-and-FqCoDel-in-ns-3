...
CoDelPeekTest::DoRun(){
  ...
  Simulator::Schedule(queue->GetTarget()*5, &CoDelPeekTest::Peek, this, queue);
...
CoDelPeekTestMark::DoRun(){
  ...
  Simulator::Schedule(queue->GetTarget()*5, &CoDelPeekTestMark::Peek, this, queue);
  nextDequeueTime =  nextDequeueTime + queue->GetInterval();
...
int main(){
    NS_LOG_UNCOND("------------------------------");
    NS_LOG_UNCOND("Test 3 for CoDel without Marking");
    NS_LOG_UNCOND("------------------------------");
    ...
    NS_LOG_UNCOND("-------------------------------------");
    NS_LOG_UNCOND("Test 3 for CoDel with Marking(only ECN)");
    NS_LOG_UNCOND("-------------------------------------");
