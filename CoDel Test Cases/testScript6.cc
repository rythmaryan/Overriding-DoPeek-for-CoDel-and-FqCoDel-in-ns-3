...
CoDelPeekTest::DoRun(){
  ...
  Time nextDequeueTime =  2 * queue->GetInterval();
  Simulator::Schedule(nextDequeueTime, &CoDelPeekTest::Dequeue, this, queue);
   
  
   nextDequeueTime =  2 * queue->GetInterval();
   Simulator::Schedule(nextDequeueTime, &CoDelPeekTest::Dequeue, this, queue);
   nextDequeueTime =  3 * queue->GetInterval();
   Simulator::Schedule(nextDequeueTime, &CoDelPeekTest::Dequeue, this, queue);
   Simulator::Schedule(nextDequeueTime, &CoDelPeekTest::Peek, this, queue);

   Simulator::Schedule(nextDequeueTime, &CoDelPeekTest::Enqueue, this, queue,pktSize,2);
   Simulator::Schedule(nextDequeueTime, &CoDelPeekTest::Peek, this, queue);
   nextDequeueTime =  4 * queue->GetInterval();
   Simulator::Schedule(nextDequeueTime, &CoDelPeekTest::Dequeue, this, queue);
   nextDequeueTime =  5 * queue->GetInterval();
   Simulator::Schedule(nextDequeueTime, &CoDelPeekTest::Dequeue, this, queue);
   nextDequeueTime =  6 * queue->GetInterval();
   Simulator::Schedule(nextDequeueTime, &CoDelPeekTest::Dequeue, this, queue);
...
CoDelPeekTestMark::DoRun(){
  ...
  Simulator::Schedule(nextDequeueTime, &CoDelPeekTestMark::Enqueue, this, queue,pktSize,2);
  Simulator::Schedule(nextDequeueTime, &CoDelPeekTestMark::Peek, this, queue);
  nextDequeueTime =  4 * queue->GetInterval();
  Simulator::Schedule(nextDequeueTime, &CoDelPeekTestMark::Dequeue, this, queue);
  nextDequeueTime =  5 * queue->GetInterval();
...
int main(){
    NS_LOG_UNCOND("------------------------------");
    NS_LOG_UNCOND("Test 6 for CoDel without Marking");
    NS_LOG_UNCOND("------------------------------");
    ...
    NS_LOG_UNCOND("-------------------------------------");
    NS_LOG_UNCOND("Test 6 for CoDel with Marking(only ECN)");
    NS_LOG_UNCOND("-------------------------------------");
